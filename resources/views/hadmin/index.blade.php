    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="/wechat/weather">
                ...
                <li>
                    <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">素材管理</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="{{url('wechat/media')}}">素材添加</a>
                        </li>
                        <li><a class="J_menuItem" href="carousel.html">素材列表</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/wechat/channel">渠道添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="">渠道列表</a>
                        </li>
                    </ul>
                </li>
            </ul>
